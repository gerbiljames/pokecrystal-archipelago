...
; entries correspond to PHONE_* constants
	...
	phone TRAINER_NONE, PHONECONTACT_WITHHELD,    N_A,                       ANYTIME, UnusedPhoneScript,        ANYTIME, UnusedPhoneScript
	phone TRAINER_NONE, PHONECONTACT_BANK_OF_MOM,    N_A,                       ANYTIME, UnusedPhoneScript,        ANYTIME, UnusedPhoneScript
	phone TRAINER_NONE, PHONECONTACT_TRAP_BROCK,    N_A,                       ANYTIME, UnusedPhoneScript,        ANYTIME, UnusedPhoneScript
	phone TRAINER_NONE, PHONECONTACT_TRAP_EUSINE,    N_A,                       ANYTIME, UnusedPhoneScript,        ANYTIME, UnusedPhoneScript
	phone TRAINER_NONE, PHONECONTACT_OUT_OF_AREA,    N_A,                       ANYTIME, UnusedPhoneScript,        ANYTIME, UnusedPhoneScript
