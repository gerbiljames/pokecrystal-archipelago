...
; HMs (ATERFALL is with the Johto itemballs)
...
; Unused: next 6 events
	const EVENT_MART_ESCAPE_ROPE
	const EVENT_MART_WATER_STONE
...
; Unused: next 339 events
	const EVENT_ZEPHYR_BADGE_FROM_FALKNER
	const EVENT_HIVE_BADGE_FROM_BUGSY
	const EVENT_PLAIN_BADGE_FROM_WHITNEY
	const EVENT_FOG_BADGE_FROM_MORTY
	const EVENT_STORM_BADGE_FROM_CHUCK
	const EVENT_MINERAL_BADGE_FROM_JASMINE
	const EVENT_GLACIER_BADGE_FROM_PRYCE
	const EVENT_RISING_BADGE_FROM_CLAIR
	const EVENT_BOULDER_BADGE_FROM_BROCK
	const EVENT_CASCADE_BADGE_FROM_MISTY
	const EVENT_THUNDER_BADGE_FROM_LTSURGE
	const EVENT_RAINBOW_BADGE_FROM_ERIKA
	const EVENT_SOUL_BADGE_FROM_JANINE
	const EVENT_MARSH_BADGE_FROM_SABRINA
	const EVENT_VOLCANO_BADGE_FROM_BLAINE
	const EVENT_EARTH_BADGE_FROM_BLUE
	const EVENT_GOT_POTION_FROM_ELMS_AIDE
	const EVENT_GOT_MYSTERY_EGG
	const EVENT_GOT_EXP_SHARE
	const EVENT_GOT_RED_SCALE
	const EVENT_GOT_POKE_BALL_FROM_ELMS_AIDE
	const EVENT_GOT_RADIO_CARD
	const EVENT_GOT_MAP_CARD
	const EVENT_GOT_PHONE_CARD
	const EVENT_GOT_EXPN_CARD
	const EVENT_GOT_POKEGEAR
	const EVENT_GOT_POKEDEX
	const EVENT_UNUSED_41
	const EVENT_UNUSED_42
	const EVENT_UNUSED_43
	const EVENT_UNUSED_44
	const EVENT_UNUSED_45
	const EVENT_UNUSED_46
	const EVENT_UNUSED_47
	const EVENT_UNUSED_48
	const EVENT_UNUSED_49
	const EVENT_UNUSED_50
	const EVENT_UNUSED_51
	const EVENT_UNUSED_52
	const EVENT_UNUSED_53
	const EVENT_UNUSED_54
	const EVENT_UNUSED_55
	const EVENT_UNUSED_56
	const EVENT_UNUSED_57
	const EVENT_UNUSED_58
	const EVENT_UNUSED_59
	const EVENT_UNUSED_60
	const EVENT_UNUSED_61
	const EVENT_UNUSED_62
	const EVENT_UNUSED_63
	const EVENT_UNUSED_64
	const EVENT_UNUSED_65
	const EVENT_UNUSED_66
	const EVENT_UNUSED_67
	const EVENT_UNUSED_68
	const EVENT_UNUSED_69
	const EVENT_UNUSED_70
	const EVENT_UNUSED_71
	const EVENT_UNUSED_72
	const EVENT_UNUSED_73
	const EVENT_UNUSED_74
...
; Phone events
	...
	const EVENT_UNUSED_362 ; unused in Crystal
	const EVENT_LIZ_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_363 ; unused in Crystal
	const EVENT_ANTHONY_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_364 ; unused in Crystal
	const EVENT_TODD_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_365 ; unused in Crystal
	const EVENT_GINA_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_366 ; unused in Crystal
	const EVENT_IRWIN_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_367 ; unused in Crystal
	const EVENT_ARNIE_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_368 ; unused in Crystal
	const EVENT_ALAN_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_369 ; unused in Crystal
	const EVENT_UNUSED_370 ; unused
	const EVENT_UNUSED_371 ; unused
	const EVENT_DANA_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_372 ; unused in Crystal
	const EVENT_CHAD_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_373 ; unused in Crystal
	const EVENT_DEREK_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_374 ; unused in Crystal
	const EVENT_TULLY_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_375 ; unused in Crystal
	const EVENT_BRENT_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_376 ; unused
	const EVENT_TIFFANY_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_377 ; unused in Crystal
	const EVENT_VANCE_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_378 ; unused in Crystal
	const EVENT_WILTON_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_379 ; unused in Crystal
	const EVENT_KENJI_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_380 ; unused in Crystal
	const EVENT_PARRY_ASKED_FOR_PHONE_NUMBER
	const EVENT_UNUSED_381 ; unused in Crystal
	const EVENT_ERIN_ASKED_FOR_PHONE_NUMBER
	const EVENT_BUENA_OFFERED_HER_PHONE_NUMBER_NO_BLUE_CARD
	const EVENT_UNUSED_382 ; unused
...
; Swimmer F
	const EVENT_ITEM_FROM_SWIMMERF_ELAINE
	const EVENT_ITEM_FROM_SWIMMERF_PAULA
	const EVENT_ITEM_FROM_SWIMMERF_KAYLEE
	const EVENT_ITEM_FROM_SWIMMERF_SUSIE
	const EVENT_ITEM_FROM_SWIMMERF_DENISE
	const EVENT_ITEM_FROM_SWIMMERF_KARA
	const EVENT_ITEM_FROM_SWIMMERF_WENDY
	const EVENT_ITEM_FROM_SWIMMERF_LISA
	const EVENT_ITEM_FROM_SWIMMERF_JILL
	const EVENT_ITEM_FROM_SWIMMERF_MARY
	const EVENT_ITEM_FROM_SWIMMERF_KATIE
	const EVENT_ITEM_FROM_SWIMMERF_DAWN
	const EVENT_ITEM_FROM_SWIMMERF_TARA
	const EVENT_ITEM_FROM_SWIMMERF_NICOLE
	const EVENT_ITEM_FROM_SWIMMERF_LORI
	const EVENT_ITEM_FROM_SWIMMERF_JODY
	const EVENT_ITEM_FROM_SWIMMERF_NIKKI
	const EVENT_ITEM_FROM_SWIMMERF_DIANA
	const EVENT_ITEM_FROM_SWIMMERF_BRIANA
	; Bird Keeper
	const EVENT_ITEM_FROM_BIRD_KEEPER_ROD
	const EVENT_ITEM_FROM_BIRD_KEEPER_ABE
	const EVENT_ITEM_FROM_BIRD_KEEPER_BRYAN
	const EVENT_ITEM_FROM_BIRD_KEEPER_THEO
	const EVENT_ITEM_FROM_BIRD_KEEPER_TOBY
	const EVENT_ITEM_FROM_BIRD_KEEPER_DENIS
	const EVENT_ITEM_FROM_BIRD_KEEPER_VANCE
	const EVENT_ITEM_FROM_BIRD_KEEPER_HANK
	const EVENT_ITEM_FROM_BIRD_KEEPER_ROY
	const EVENT_ITEM_FROM_BIRD_KEEPER_BORIS
	const EVENT_ITEM_FROM_BIRD_KEEPER_BOB
	const EVENT_ITEM_FROM_BIRD_KEEPER_JOSE
	const EVENT_ITEM_FROM_BIRD_KEEPER_PETER
	const EVENT_ITEM_FROM_BIRD_KEEPER_JOSE2
	const EVENT_ITEM_FROM_BIRD_KEEPER_PERRY
	const EVENT_ITEM_FROM_BIRD_KEEPER_BRET
	const EVENT_ITEM_FROM_BIRD_KEEPER_JOSE3
	const EVENT_ITEM_FROM_BIRD_KEEPER_VANCE2
	const EVENT_ITEM_FROM_BIRD_KEEPER_VANCE3
	; Boarder
	const EVENT_ITEM_FROM_BOARDER_RONALD
	const EVENT_ITEM_FROM_BOARDER_BRAD
	const EVENT_ITEM_FROM_BOARDER_DOUGLAS
	; Sage
	const EVENT_ITEM_FROM_SAGE_CHOW
	const EVENT_ITEM_FROM_SAGE_NICO
	const EVENT_ITEM_FROM_SAGE_JIN
	const EVENT_ITEM_FROM_SAGE_TROY
	const EVENT_ITEM_FROM_SAGE_JEFFREY
	const EVENT_ITEM_FROM_SAGE_PING
	const EVENT_ITEM_FROM_SAGE_EDMOND
	const EVENT_ITEM_FROM_SAGE_NEAL
	const EVENT_ITEM_FROM_SAGE_LI
	; Camper
	const EVENT_ITEM_FROM_CAMPER_ROLAND
	const EVENT_ITEM_FROM_CAMPER_TODD
	const EVENT_ITEM_FROM_CAMPER_IVAN
	const EVENT_ITEM_FROM_CAMPER_ELLIOT
	const EVENT_ITEM_FROM_CAMPER_BARRY
	const EVENT_ITEM_FROM_CAMPER_LLOYD
	const EVENT_ITEM_FROM_CAMPER_DEAN
	const EVENT_ITEM_FROM_CAMPER_SID
	const EVENT_ITEM_FROM_CAMPER_HERVEY
	const EVENT_ITEM_FROM_CAMPER_DALE
	const EVENT_ITEM_FROM_CAMPER_TED
	const EVENT_ITEM_FROM_CAMPER_TODD2
	const EVENT_ITEM_FROM_CAMPER_TODD3
	const EVENT_ITEM_FROM_CAMPER_THOMAS
	const EVENT_ITEM_FROM_CAMPER_LEROY
	const EVENT_ITEM_FROM_CAMPER_DAVID
	const EVENT_ITEM_FROM_CAMPER_JOHN
	const EVENT_ITEM_FROM_CAMPER_JERRY
	const EVENT_ITEM_FROM_CAMPER_SPENCER
	; Burglar
	const EVENT_ITEM_FROM_BURGLAR_DUNCAN
	const EVENT_ITEM_FROM_BURGLAR_EDDIE
	const EVENT_ITEM_FROM_BURGLAR_COREY
	const EVENT_UNUSED_384_2 ; unused
	; Biker
	const EVENT_ITEM_FROM_BIKER_BENNY
	const EVENT_ITEM_FROM_BIKER_KAZU
	const EVENT_ITEM_FROM_BIKER_DWAYNE
	const EVENT_ITEM_FROM_BIKER_HARRIS
	const EVENT_ITEM_FROM_BIKER_ZEKE
	const EVENT_ITEM_FROM_BIKER_CHARLES
	const EVENT_ITEM_FROM_BIKER_RILEY
	const EVENT_ITEM_FROM_BIKER_JOEL
	const EVENT_ITEM_FROM_BIKER_GLENN
	; Psychic
	const EVENT_ITEM_FROM_PSYCHIC_NATHAN
	const EVENT_ITEM_FROM_PSYCHIC_FRANKLIN
	const EVENT_ITEM_FROM_PSYCHIC_HERMAN
	const EVENT_ITEM_FROM_PSYCHIC_FIDEL
	const EVENT_ITEM_FROM_PSYCHIC_GREG
	const EVENT_ITEM_FROM_PSYCHIC_NORMAN
	const EVENT_ITEM_FROM_PSYCHIC_MARK
	const EVENT_ITEM_FROM_PSYCHIC_PHIL
	const EVENT_ITEM_FROM_PSYCHIC_RICHARD
	const EVENT_ITEM_FROM_PSYCHIC_GILBERT
	const EVENT_ITEM_FROM_PSYCHIC_JARED
	const EVENT_ITEM_FROM_PSYCHIC_RODNEY
	; Firebreather
	const EVENT_ITEM_FROM_FIREBREATHER_OTIS
	const EVENT_ITEM_FROM_FIREBREATHER_DICK
	const EVENT_ITEM_FROM_FIREBREATHER_NED
	const EVENT_ITEM_FROM_FIREBREATHER_BURT
	const EVENT_ITEM_FROM_FIREBREATHER_BILL
	const EVENT_ITEM_FROM_FIREBREATHER_WALT
	const EVENT_ITEM_FROM_FIREBREATHER_RAY
	const EVENT_ITEM_FROM_FIREBREATHER_LYLE
	; Fisher
	const EVENT_ITEM_FROM_FISHER_JUSTIN
	const EVENT_ITEM_FROM_FISHER_RALPH
	const EVENT_ITEM_FROM_FISHER_ARNOLD
	const EVENT_ITEM_FROM_FISHER_KYLE
	const EVENT_ITEM_FROM_FISHER_HENRY
	const EVENT_ITEM_FROM_FISHER_MARVIN
	const EVENT_ITEM_FROM_FISHER_TULLY
	const EVENT_ITEM_FROM_FISHER_ANDRE
	const EVENT_ITEM_FROM_FISHER_RAYMOND
	const EVENT_ITEM_FROM_FISHER_WILTON
	const EVENT_ITEM_FROM_FISHER_EDGAR
	const EVENT_ITEM_FROM_FISHER_JONAH
	const EVENT_ITEM_FROM_FISHER_MARTIN
	const EVENT_ITEM_FROM_FISHER_STEPHEN
	const EVENT_ITEM_FROM_FISHER_BARNEY
	const EVENT_ITEM_FROM_FISHER_RALPH2
	const EVENT_ITEM_FROM_FISHER_RALPH3
	const EVENT_ITEM_FROM_FISHER_TULLY2
	const EVENT_ITEM_FROM_FISHER_TULLY3
	const EVENT_ITEM_FROM_FISHER_WILTON2
	const EVENT_ITEM_FROM_FISHER_SCOTT
	const EVENT_ITEM_FROM_FISHER_WILTON3
	; Twins
	const EVENT_ITEM_FROM_TWINS_AMY_AND_MAY
	const EVENT_ITEM_FROM_TWINS_ANN_AND_ANNE
	const EVENT_ITEM_FROM_TWINS_ANN_AND_ANNE2
	const EVENT_ITEM_FROM_TWINS_AMY_AND_MAY2
	const EVENT_ITEM_FROM_TWINS_JO_AND_ZOE
	const EVENT_ITEM_FROM_TWINS_JO_AND_ZOE2
	const EVENT_ITEM_FROM_TWINS_MEG_AND_PEG
	const EVENT_ITEM_FROM_TWINS_MEG_AND_PEG2
	; Schoolboy
	const EVENT_ITEM_FROM_SCHOOLBOY_JACK
	const EVENT_ITEM_FROM_SCHOOLBOY_KIP
	const EVENT_ITEM_FROM_SCHOOLBOY_ALAN
	const EVENT_ITEM_FROM_SCHOOLBOY_JOHNNY
	const EVENT_ITEM_FROM_SCHOOLBOY_DANNY
	const EVENT_ITEM_FROM_SCHOOLBOY_TOMMY
	const EVENT_ITEM_FROM_SCHOOLBOY_DUDLEY
	const EVENT_ITEM_FROM_SCHOOLBOY_JOE
	const EVENT_ITEM_FROM_SCHOOLBOY_BILLY
	const EVENT_ITEM_FROM_SCHOOLBOY_CHAD
	const EVENT_ITEM_FROM_SCHOOLBOY_NATE
	const EVENT_ITEM_FROM_SCHOOLBOY_RICKY
	const EVENT_ITEM_FROM_SCHOOLBOY_JACK2
	const EVENT_ITEM_FROM_SCHOOLBOY_JACK3
	const EVENT_ITEM_FROM_SCHOOLBOY_ALAN2
	const EVENT_ITEM_FROM_SCHOOLBOY_ALAN3
	const EVENT_ITEM_FROM_SCHOOLBOY_CHAD2
	const EVENT_ITEM_FROM_SCHOOLBOY_CHAD3
	; Picnicker
	const EVENT_ITEM_FROM_PICNICKER_LIZ
	const EVENT_ITEM_FROM_PICNICKER_GINA
	const EVENT_ITEM_FROM_PICNICKER_BROOKE
	const EVENT_ITEM_FROM_PICNICKER_KIM
	const EVENT_ITEM_FROM_PICNICKER_CINDY
	const EVENT_ITEM_FROM_PICNICKER_HOPE
	const EVENT_ITEM_FROM_PICNICKER_SHARON
	const EVENT_ITEM_FROM_PICNICKER_DEBRA
	const EVENT_ITEM_FROM_PICNICKER_GINA2
	const EVENT_ITEM_FROM_PICNICKER_ERIN
	const EVENT_ITEM_FROM_PICNICKER_LIZ2
	const EVENT_ITEM_FROM_PICNICKER_LIZ3
	const EVENT_ITEM_FROM_PICNICKER_HEIDI
	const EVENT_ITEM_FROM_PICNICKER_EDNA
	const EVENT_ITEM_FROM_PICNICKER_GINA3
	const EVENT_ITEM_FROM_PICNICKER_TIFFANY2
	const EVENT_ITEM_FROM_PICNICKER_TIFFANY3
	const EVENT_ITEM_FROM_PICNICKER_ERIN2
	const EVENT_ITEM_FROM_PICNICKER_TANYA
	const EVENT_ITEM_FROM_PICNICKER_TIFFANY
	const EVENT_ITEM_FROM_PICNICKER_ERIN3
	; Guitarist
	const EVENT_ITEM_FROM_GUITARIST_CLYDE
	const EVENT_ITEM_FROM_GUITARIST_VINCENT
	; Juggler
	const EVENT_ITEM_FROM_JUGGLER_IRWIN
	const EVENT_ITEM_FROM_JUGGLER_FRITZ
	const EVENT_ITEM_FROM_JUGGLER_HORTON
	const EVENT_ITEM_FROM_JUGGLER_IRWIN2
	const EVENT_ITEM_FROM_JUGGLER_IRWIN3
	; Gentleman
	const EVENT_ITEM_FROM_GENTLEMAN_PRESTON
	const EVENT_ITEM_FROM_GENTLEMAN_EDWARD
	const EVENT_ITEM_FROM_GENTLEMAN_GREGORY
	const EVENT_ITEM_FROM_GENTLEMAN_VIRGIL
	const EVENT_ITEM_FROM_GENTLEMAN_ALFRED
	; Scientist
	const EVENT_ITEM_FROM_SCIENTIST_ROSS
	const EVENT_ITEM_FROM_SCIENTIST_MITCH
	const EVENT_ITEM_FROM_SCIENTIST_JED
	const EVENT_ITEM_FROM_SCIENTIST_MARC
	const EVENT_ITEM_FROM_SCIENTIST_RICH
	; Blackbelt
	const EVENT_ITEM_FROM_BLACKBELT_KENJI2
	const EVENT_ITEM_FROM_BLACKBELT_YOSHI
	const EVENT_ITEM_FROM_BLACKBELT_KENJI3
	const EVENT_ITEM_FROM_BLACKBELT_LAO
	const EVENT_ITEM_FROM_BLACKBELT_NOB
	const EVENT_ITEM_FROM_BLACKBELT_KIYO
	const EVENT_ITEM_FROM_BLACKBELT_LUNG
	const EVENT_ITEM_FROM_BLACKBELT_KENJI
	const EVENT_ITEM_FROM_BLACKBELT_WAI
	; Beauty
	const EVENT_ITEM_FROM_BEAUTY_VICTORIA
	const EVENT_ITEM_FROM_BEAUTY_SAMANTHA
	const EVENT_ITEM_FROM_BEAUTY_JULIE
	const EVENT_ITEM_FROM_BEAUTY_JACLYN
	const EVENT_ITEM_FROM_BEAUTY_BRENDA
	const EVENT_ITEM_FROM_BEAUTY_CASSIE
	const EVENT_ITEM_FROM_BEAUTY_CAROLINE
	const EVENT_ITEM_FROM_BEAUTY_CARLENE
	const EVENT_ITEM_FROM_BEAUTY_JESSICA
	const EVENT_ITEM_FROM_BEAUTY_RACHAEL
	const EVENT_ITEM_FROM_BEAUTY_ANGELICA
	const EVENT_ITEM_FROM_BEAUTY_KENDRA
	const EVENT_ITEM_FROM_BEAUTY_VERONICA
	const EVENT_ITEM_FROM_BEAUTY_JULIA
	const EVENT_ITEM_FROM_BEAUTY_THERESA
	const EVENT_ITEM_FROM_BEAUTY_VALERIE
	; Johto Gym Leaders
	const EVENT_ITEM_FROM_FALKNER
	const EVENT_ITEM_FROM_BUGSY
	const EVENT_ITEM_FROM_WHITNEY
	const EVENT_ITEM_FROM_MORTY
	const EVENT_ITEM_FROM_JASMINE
	const EVENT_ITEM_FROM_CHUCK
	const EVENT_ITEM_FROM_PRYCE
	const EVENT_ITEM_FROM_CLAIR
	; Kanto Gym Leaders
	const EVENT_ITEM_FROM_BROCK
	const EVENT_ITEM_FROM_MISTY
	const EVENT_ITEM_FROM_LTSURGE
	const EVENT_ITEM_FROM_ERIKA
	const EVENT_ITEM_FROM_JANINE
	const EVENT_ITEM_FROM_SABRINA
	const EVENT_ITEM_FROM_BLAINE
	const EVENT_ITEM_FROM_BLUE
	; PokefanM
	const EVENT_ITEM_FROM_POKEFANM_WILLIAM
	const EVENT_ITEM_FROM_POKEFANM_DEREK
	const EVENT_ITEM_FROM_POKEFANM_ROBERT
	const EVENT_ITEM_FROM_POKEFANM_JOSHUA
	const EVENT_ITEM_FROM_POKEFANM_CARTER
	const EVENT_ITEM_FROM_POKEFANM_TREVOR
	const EVENT_ITEM_FROM_POKEFANM_BRANDON
	const EVENT_ITEM_FROM_POKEFANM_JEREMY
	const EVENT_ITEM_FROM_POKEFANM_COLIN
	const EVENT_ITEM_FROM_POKEFANM_DEREK2
	const EVENT_ITEM_FROM_POKEFANM_DEREK3
	const EVENT_ITEM_FROM_POKEFANM_ALEX
	; PokefanF
	const EVENT_ITEM_FROM_POKEFANF_BEVERLY
	const EVENT_ITEM_FROM_POKEFANF_RUTH
	const EVENT_ITEM_FROM_POKEFANF_BEVERLY2
	const EVENT_ITEM_FROM_POKEFANF_BEVERLY3
	const EVENT_ITEM_FROM_POKEFANF_GEORGIA
	; Kimono Girl
	const EVENT_UNUSED_385_2 ; unused
	const EVENT_ITEM_FROM_KIMONO_GIRL_NAOKO
	const EVENT_ITEM_FROM_KIMONO_GIRL_SAYO
	const EVENT_ITEM_FROM_KIMONO_GIRL_ZUKI
	const EVENT_ITEM_FROM_KIMONO_GIRL_KUNI
	const EVENT_ITEM_FROM_KIMONO_GIRL_MIKI
	; Pokemaniac
	const EVENT_ITEM_FROM_POKEMANIAC_LARRY
	const EVENT_ITEM_FROM_POKEMANIAC_ANDREW
	const EVENT_ITEM_FROM_POKEMANIAC_CALVIN
	const EVENT_ITEM_FROM_POKEMANIAC_SHANE
	const EVENT_ITEM_FROM_POKEMANIAC_BEN
	const EVENT_ITEM_FROM_POKEMANIAC_BRENT
	const EVENT_ITEM_FROM_POKEMANIAC_RON
	const EVENT_ITEM_FROM_POKEMANIAC_ETHAN
	const EVENT_ITEM_FROM_POKEMANIAC_BRENT2
	const EVENT_ITEM_FROM_POKEMANIAC_BRENT3
	const EVENT_ITEM_FROM_POKEMANIAC_ISSAC
	const EVENT_ITEM_FROM_POKEMANIAC_DONALD
	const EVENT_ITEM_FROM_POKEMANIAC_ZACH
	; GruntM
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_1
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_2
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_3
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_4
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_5
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_6
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_7
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_8
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_9
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_10
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_11
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_12
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_13
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_14
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_15
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_16
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_17
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_18
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_19
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_20
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_21
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_22
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_23
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_24
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_25
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_26
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_27
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_28
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_29
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_30
	const EVENT_ITEM_FROM_ROCKET_GRUNTM_31
	; GruntF
	const EVENT_ITEM_FROM_ROCKET_GRUNTF_1
	const EVENT_ITEM_FROM_ROCKET_GRUNTF_2
	const EVENT_ITEM_FROM_ROCKET_GRUNTF_3
	const EVENT_ITEM_FROM_ROCKET_GRUNTF_4
	const EVENT_ITEM_FROM_ROCKET_GRUNTF_5
	; Lass
	const EVENT_ITEM_FROM_LASS_CARRIE
	const EVENT_ITEM_FROM_LASS_BRIDGET
	const EVENT_ITEM_FROM_LASS_ALICE
	const EVENT_ITEM_FROM_LASS_KRISE
	const EVENT_ITEM_FROM_LASS_CONNIE
	const EVENT_ITEM_FROM_LASS_LINDA
	const EVENT_ITEM_FROM_LASS_LAURA
	const EVENT_ITEM_FROM_LASS_SHANNON
	const EVENT_ITEM_FROM_LASS_MICHELLE
	const EVENT_ITEM_FROM_LASS_DANA
	const EVENT_ITEM_FROM_LASS_ELLEN
	const EVENT_ITEM_FROM_LASS_CONNIE2
	const EVENT_ITEM_FROM_LASS_CONNIE3
	const EVENT_ITEM_FROM_LASS_DANA2
	const EVENT_ITEM_FROM_LASS_DANA3
	; Hiker
	const EVENT_ITEM_FROM_HIKER_ANTHONY2
	const EVENT_ITEM_FROM_HIKER_RUSSELL
	const EVENT_ITEM_FROM_HIKER_PHILLIP
	const EVENT_ITEM_FROM_HIKER_LEONARD
	const EVENT_ITEM_FROM_HIKER_ANTHONY
	const EVENT_ITEM_FROM_HIKER_BENJAMIN
	const EVENT_ITEM_FROM_HIKER_ERIK
	const EVENT_ITEM_FROM_HIKER_MICHAEL
	const EVENT_ITEM_FROM_HIKER_PARRY
	const EVENT_ITEM_FROM_HIKER_TIMOTHY
	const EVENT_ITEM_FROM_HIKER_BAILEY
	const EVENT_ITEM_FROM_HIKER_ANTHONY3
	const EVENT_ITEM_FROM_HIKER_TIM
	const EVENT_ITEM_FROM_HIKER_NOLAND
	const EVENT_ITEM_FROM_HIKER_SIDNEY
	const EVENT_ITEM_FROM_HIKER_KENNY
	const EVENT_ITEM_FROM_HIKER_JIM
	const EVENT_ITEM_FROM_HIKER_DANIEL
	const EVENT_ITEM_FROM_HIKER_PARRY2
	const EVENT_ITEM_FROM_HIKER_PARRY3
	; Bug Catcher
	const EVENT_ITEM_FROM_BUG_CATCHER_DON
	const EVENT_ITEM_FROM_BUG_CATCHER_ROB
	const EVENT_ITEM_FROM_BUG_CATCHER_ED
	const EVENT_ITEM_FROM_BUG_CATCHER_WADE
	const EVENT_ITEM_FROM_BUG_CATCHER_BENNY
	const EVENT_ITEM_FROM_BUG_CATCHER_AL
	const EVENT_ITEM_FROM_BUG_CATCHER_JOSH
	const EVENT_ITEM_FROM_BUG_CATCHER_ARNIE
	const EVENT_ITEM_FROM_BUG_CATCHER_KEN
	const EVENT_ITEM_FROM_BUG_CATCHER_WADE2
	const EVENT_ITEM_FROM_BUG_CATCHER_WADE3
	const EVENT_ITEM_FROM_BUG_CATCHER_DOUG
	const EVENT_ITEM_FROM_BUG_CATCHER_ARNIE2
	const EVENT_ITEM_FROM_BUG_CATCHER_ARNIE3
	; Officer
	const EVENT_ITEM_FROM_OFFICER_KEITH
	const EVENT_ITEM_FROM_OFFICER_DIRK
	; CooltrainerM
	const EVENT_ITEM_FROM_COOLTRAINERM_NICK
	const EVENT_ITEM_FROM_COOLTRAINERM_AARON
	const EVENT_ITEM_FROM_COOLTRAINERM_PAUL
	const EVENT_ITEM_FROM_COOLTRAINERM_CODY
	const EVENT_ITEM_FROM_COOLTRAINERM_MIKE
	const EVENT_ITEM_FROM_COOLTRAINERM_GAVEN2
	const EVENT_ITEM_FROM_COOLTRAINERM_GAVEN3
	const EVENT_ITEM_FROM_COOLTRAINERM_RYAN
	const EVENT_ITEM_FROM_COOLTRAINERM_JAKE
	const EVENT_ITEM_FROM_COOLTRAINERM_GAVEN
	const EVENT_ITEM_FROM_COOLTRAINERM_BLAKE
	const EVENT_ITEM_FROM_COOLTRAINERM_BRIAN
	const EVENT_ITEM_FROM_COOLTRAINERM_ERICK
	const EVENT_ITEM_FROM_COOLTRAINERM_ANDY
	const EVENT_ITEM_FROM_COOLTRAINERM_TYLER
	const EVENT_ITEM_FROM_COOLTRAINERM_SEAN
	const EVENT_ITEM_FROM_COOLTRAINERM_KEVIN
	const EVENT_ITEM_FROM_COOLTRAINERM_STEVE
	const EVENT_ITEM_FROM_COOLTRAINERM_ALLEN
	; CooltrainerF
	const EVENT_ITEM_FROM_COOLTRAINERF_GWEN
	const EVENT_ITEM_FROM_COOLTRAINERF_LOIS
	const EVENT_ITEM_FROM_COOLTRAINERF_FRAN
	const EVENT_ITEM_FROM_COOLTRAINERF_LOLA
	const EVENT_ITEM_FROM_COOLTRAINERF_KATE
	const EVENT_ITEM_FROM_COOLTRAINERF_IRENE
	const EVENT_ITEM_FROM_COOLTRAINERF_KELLY
	const EVENT_ITEM_FROM_COOLTRAINERF_JOYCE
	const EVENT_ITEM_FROM_COOLTRAINERF_BETH
	const EVENT_ITEM_FROM_COOLTRAINERF_REENA
	const EVENT_ITEM_FROM_COOLTRAINERF_MEGAN
	const EVENT_ITEM_FROM_COOLTRAINERF_BETH2
	const EVENT_ITEM_FROM_COOLTRAINERF_CAROL
	const EVENT_ITEM_FROM_COOLTRAINERF_QUINN
	const EVENT_ITEM_FROM_COOLTRAINERF_EMMA
	const EVENT_ITEM_FROM_COOLTRAINERF_CYBIL
	const EVENT_ITEM_FROM_COOLTRAINERF_JENN
	const EVENT_ITEM_FROM_COOLTRAINERF_BETH3
	const EVENT_ITEM_FROM_COOLTRAINERF_REENA2
	const EVENT_ITEM_FROM_COOLTRAINERF_REENA3
	; ExecutiveF
	const EVENT_ITEM_FROM_ROCKET_EXECUTIVEF_1
	const EVENT_ITEM_FROM_ROCKET_EXECUTIVEF_2
	; ExecutiveM
	const EVENT_ITEM_FROM_ROCKET_EXECUTIVEM_1
	const EVENT_ITEM_FROM_ROCKET_EXECUTIVEM_2
	const EVENT_ITEM_FROM_ROCKET_EXECUTIVEM_3
	const EVENT_ITEM_FROM_ROCKET_EXECUTIVEM_4
	; Sailor
	const EVENT_ITEM_FROM_SAILOR_EUGENE
	const EVENT_ITEM_FROM_SAILOR_HUEY
	const EVENT_ITEM_FROM_SAILOR_TERRELL
	const EVENT_ITEM_FROM_SAILOR_KENT
	const EVENT_ITEM_FROM_SAILOR_ERNEST
	const EVENT_ITEM_FROM_SAILOR_JEFF
	const EVENT_ITEM_FROM_SAILOR_GARRETT
	const EVENT_ITEM_FROM_SAILOR_KENNETH
	const EVENT_ITEM_FROM_SAILOR_STANLY
	const EVENT_ITEM_FROM_SAILOR_HARRY
	const EVENT_ITEM_FROM_SAILOR_HUEY2
	const EVENT_ITEM_FROM_SAILOR_HUEY3
	; Super Nerd
	const EVENT_ITEM_FROM_SUPER_NERD_STAN
	const EVENT_ITEM_FROM_SUPER_NERD_ERIC
	const EVENT_ITEM_FROM_SUPER_NERD_GREGG
	const EVENT_ITEM_FROM_SUPER_NERD_JAY
	const EVENT_ITEM_FROM_SUPER_NERD_DAVE
	const EVENT_ITEM_FROM_SUPER_NERD_SAM
	const EVENT_ITEM_FROM_SUPER_NERD_TOM
	const EVENT_ITEM_FROM_SUPER_NERD_PAT
	const EVENT_ITEM_FROM_SUPER_NERD_SHAWN
	const EVENT_ITEM_FROM_SUPER_NERD_TERU
	; Medium
	const EVENT_ITEM_FROM_MEDIUM_MARTHA
	const EVENT_ITEM_FROM_MEDIUM_GRACE
	const EVENT_ITEM_FROM_MEDIUM_BETHANY
	const EVENT_ITEM_FROM_MEDIUM_MARGRET
	const EVENT_ITEM_FROM_MEDIUM_ETHEL
	const EVENT_ITEM_FROM_MEDIUM_REBECCA
	const EVENT_ITEM_FROM_MEDIUM_DORIS
	; Skier
	const EVENT_ITEM_FROM_SKIER_ROXANNE
	const EVENT_ITEM_FROM_SKIER_CLARISSA
	; SwimmerM
	const EVENT_ITEM_FROM_SWIMMERM_HAROLD
	const EVENT_ITEM_FROM_SWIMMERM_SIMON
	const EVENT_ITEM_FROM_SWIMMERM_RANDALL
	const EVENT_ITEM_FROM_SWIMMERM_CHARLIE
	const EVENT_ITEM_FROM_SWIMMERM_GEORGE
	const EVENT_ITEM_FROM_SWIMMERM_BERKE
	const EVENT_ITEM_FROM_SWIMMERM_KIRK
	const EVENT_ITEM_FROM_SWIMMERM_MATHEW
	const EVENT_ITEM_FROM_SWIMMERM_HAL
	const EVENT_ITEM_FROM_SWIMMERM_PATON
	const EVENT_ITEM_FROM_SWIMMERM_DARYL
	const EVENT_ITEM_FROM_SWIMMERM_WALTER
	const EVENT_ITEM_FROM_SWIMMERM_TONY
	const EVENT_ITEM_FROM_SWIMMERM_JEROME
	const EVENT_ITEM_FROM_SWIMMERM_TUCKER
	const EVENT_ITEM_FROM_SWIMMERM_RICK
	const EVENT_ITEM_FROM_SWIMMERM_CAMERON
	const EVENT_ITEM_FROM_SWIMMERM_SETH
	const EVENT_ITEM_FROM_SWIMMERM_JAMES
	const EVENT_ITEM_FROM_SWIMMERM_LEWIS
	const EVENT_ITEM_FROM_SWIMMERM_PARKER
	; Youngster
	const EVENT_ITEM_FROM_YOUNGSTER_JOEY
	const EVENT_ITEM_FROM_YOUNGSTER_MIKEY
	const EVENT_ITEM_FROM_YOUNGSTER_ALBERT
	const EVENT_ITEM_FROM_YOUNGSTER_GORDON
	const EVENT_ITEM_FROM_YOUNGSTER_SAMUEL
	const EVENT_ITEM_FROM_YOUNGSTER_IAN
	const EVENT_ITEM_FROM_YOUNGSTER_JOEY2
	const EVENT_ITEM_FROM_YOUNGSTER_JOEY3
	const EVENT_ITEM_FROM_YOUNGSTER_WARREN
	const EVENT_ITEM_FROM_YOUNGSTER_JIMMY
	const EVENT_ITEM_FROM_YOUNGSTER_OWEN
	const EVENT_ITEM_FROM_YOUNGSTER_JASON
	; Teacher
	const EVENT_ITEM_FROM_TEACHER_COLETTE
	const EVENT_ITEM_FROM_TEACHER_HILLARY
	const EVENT_ITEM_FROM_TEACHER_SHIRLEY
	; Elite Four and Champion
	const EVENT_ITEM_FROM_ELITE_4_WILL
	const EVENT_ITEM_FROM_ELITE_4_KOGA
	const EVENT_ITEM_FROM_ELITE_4_BRUNO
	const EVENT_ITEM_FROM_ELITE_4_KAREN
	const EVENT_ITEM_FROM_CHAMPION_LANCE
	; Crystal-exclusive trainer flags
	const EVENT_ITEM_FROM_COOLTRAINERM_DARIN
	const EVENT_ITEM_FROM_COOLTRAINERF_CARA
	const EVENT_ITEM_FROM_TWINS_LEA_AND_PIA
	const EVENT_ITEM_FROM_BUG_CATCHER_WAYNE
	const EVENT_ITEM_FROM_BEAUTY_OLIVIA
	const EVENT_ITEM_FROM_POKEFANF_JAIME
	const EVENT_ITEM_FROM_CAMPER_QUENTIN
	const EVENT_ITEM_FROM_POKEMANIAC_MILLER
	const EVENT_ITEM_FROM_SUPER_NERD_HUGH
	const EVENT_ITEM_FROM_SUPER_NERD_MARKUS
	const EVENT_ITEM_FROM_POKEFANM_REX
	const EVENT_ITEM_FROM_POKEFANM_ALLAN
	const EVENT_ITEM_FROM_SAGE_GAKU
	const EVENT_ITEM_FROM_SAGE_MASA
	const EVENT_ITEM_FROM_SAGE_KOJI
...
; Johto people
	...
	const EVENT_ROCKET_TAKEOVER_OR_AFTER
...
; Unused: next 48 events
	const EVENT_BLUE_GYM_TRACKER
	const EVENT_UNUSED_506
	const EVENT_UNUSED_507
	const EVENT_UNUSED_508
	const EVENT_UNUSED_509
	const EVENT_UNUSED_510
	const EVENT_UNUSED_511
	const EVENT_UNUSED_512
	const EVENT_UNUSED_513
	const EVENT_UNUSED_514
	const EVENT_UNUSED_515
	const EVENT_UNUSED_516
	const EVENT_UNUSED_517
	const EVENT_UNUSED_518
	const EVENT_UNUSED_519
	const EVENT_UNUSED_520
	const EVENT_UNUSED_521
	const EVENT_UNUSED_522
	const EVENT_UNUSED_523
	const EVENT_UNUSED_524
	const EVENT_UNUSED_525
	const EVENT_UNUSED_526
	const EVENT_UNUSED_527
	const EVENT_UNUSED_528
	const EVENT_UNUSED_529
	const EVENT_UNUSED_530
	const EVENT_UNUSED_531
	const EVENT_UNUSED_532
	const EVENT_UNUSED_533
	const EVENT_UNUSED_534
	const EVENT_UNUSED_535
	const EVENT_UNUSED_536
	const EVENT_UNUSED_537
	const EVENT_UNUSED_538
	const EVENT_UNUSED_539
	const EVENT_UNUSED_540
	const EVENT_UNUSED_541
	const EVENT_UNUSED_542
	const EVENT_UNUSED_543
	const EVENT_UNUSED_544
	const EVENT_UNUSED_545
	const EVENT_UNUSED_546
	const EVENT_UNUSED_547
	const EVENT_UNUSED_548
	const EVENT_UNUSED_549
	const EVENT_UNUSED_550
	const EVENT_UNUSED_551
	const EVENT_UNUSED_552
	const EVENT_UNUSED_553
	const EVENT_UNUSED_554
	const EVENT_UNUSED_555
	const EVENT_UNUSED_556
	const EVENT_UNUSED_557
	const EVENT_UNUSED_558
	const EVENT_UNUSED_559
	const EVENT_UNUSED_560
	const EVENT_UNUSED_561
	const EVENT_UNUSED_562
	const EVENT_UNUSED_563
	const EVENT_UNUSED_564
	const EVENT_UNUSED_565
	const EVENT_UNUSED_566
	const EVENT_UNUSED_567
	const EVENT_UNUSED_568
	const EVENT_UNUSED_569
	const EVENT_UNUSED_570
	const EVENT_UNUSED_571
	const EVENT_UNUSED_572
	const EVENT_UNUSED_573
	const EVENT_UNUSED_574
	const EVENT_UNUSED_575
	const EVENT_UNUSED_576
	const EVENT_UNUSED_577
	const EVENT_UNUSED_578
	const EVENT_UNUSED_579
	const EVENT_UNUSED_580
	const EVENT_UNUSED_581
	const EVENT_UNUSED_582
	const EVENT_UNUSED_583
	const EVENT_UNUSED_584
	const EVENT_UNUSED_585
	const EVENT_UNUSED_586
	const EVENT_UNUSED_587
	const EVENT_UNUSED_588
	const EVENT_UNUSED_589
	const EVENT_UNUSED_590
	const EVENT_UNUSED_591
	const EVENT_UNUSED_592
	const EVENT_UNUSED_593
	const EVENT_UNUSED_594
	const EVENT_UNUSED_595
	const EVENT_UNUSED_596
	const EVENT_UNUSED_597
	const EVENT_UNUSED_598
	const EVENT_UNUSED_599
	const EVENT_UNUSED_600
	const EVENT_UNUSED_601
	const EVENT_UNUSED_602
	const EVENT_UNUSED_603
	const EVENT_UNUSED_604
	const EVENT_UNUSED_605
	const EVENT_UNUSED_606
	const EVENT_UNUSED_607
	const EVENT_UNUSED_608
	const EVENT_UNUSED_609
	const EVENT_UNUSED_610
	const EVENT_UNUSED_611
	const EVENT_UNUSED_612
	const EVENT_UNUSED_613
	const EVENT_UNUSED_614
	const EVENT_UNUSED_615
	const EVENT_UNUSED_616
	const EVENT_UNUSED_617
	const EVENT_UNUSED_618
	const EVENT_UNUSED_619
	const EVENT_UNUSED_620
	const EVENT_UNUSED_621
	const EVENT_UNUSED_622
	const EVENT_UNUSED_623
	const EVENT_UNUSED_624
	const EVENT_UNUSED_625
	const EVENT_UNUSED_626
	const EVENT_UNUSED_627
	const EVENT_UNUSED_628
