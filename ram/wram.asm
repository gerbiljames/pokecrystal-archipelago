...
wTrainersanityItem:: db
wTrainersanityEventFlag:: dw
wRunningTrainerBattleScript:: db
wTempTrainerEnd::
wTrainersanityShowMessage:: db
...
; wLastBadgeCount:: ds 1
; wStartInventorySet:: ds 1
...
wArchipelagoItemIndex:: db
wArchipelagoItemIndex2:: db
wArchipelagoSafeWrite:: db
wArchipelagoPhoneTrapReadIndex:: db
wArchipelagoPhoneTrapIndex:: db
wArchipelagoBonkCount:: db
wArchipelagoBonkCount2:: db
