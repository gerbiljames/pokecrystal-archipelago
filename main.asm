...
INCLUDE "engine/phone/scripts/ap.asm"
...
SECTION "AP Item Text 1", ROMX
INCLUDE "data/ap/ap_item_text_1.asm"

SECTION "AP Item Text 2", ROMX
INCLUDE "data/ap/ap_item_text_2.asm"
...
SECTION "AP Phone Calls Text", ROMX
INCLUDE "data/phone/text/ap.asm"
...
AP_Setting_Phone_Trap_Locations:
ds $80
