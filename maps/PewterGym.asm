...
PewterGymBrockScript:
	faceplayer
	opentext
	checkevent EVENT_BOULDER_BADGE_FROM_BROCK
	iftrue .FightDone
	...
	opentext
.AP_Badge_PewterGym_BOULDER_BADGE
	verbosegiveitem BOULDER_BADGE, EVENT_BOULDER_BADGE_FROM_BROCK
	setevent EVENT_BOULDER_BADGE_FROM_BROCK
