...
MrPokemonsHouseMrPokemonEventScript:
	...
	promptbutton
	waitsfx
.AP_NPC_MrPokemonsHouse_MYSTERY_EGG
	verbosegiveitem MYSTERY_EGG, EVENT_GOT_MYSTERY_EGG
...
.RedScale:
	...
	yesorno
	iffalse .refused
.AP_NPC_MrPokemonsHouse_EXP_SHARE
	verbosegiveitem EXP_SHARE, EVENT_GOT_EXP_SHARE
	iffalse .full
	takeitem RED_SCALE
...
.AP_Music_MrPokemonsHouse__MUSIC_PROF_OAK
	...
	promptbutton
	waitsfx
.AP_NPC_MrPokemonsHouse_POKE_DEX
	verbosegiveitem POKE_DEX, EVENT_GOT_POKEDEX
...
.AP_Music_MrPokemonsHouse__MUSIC_HEAL
