...
PokemonFanClubChairmanScript:
	...
	promptbutton
.repeat
	writetext PokemonFanClubChairmanRapidashText2
	promptbutton
	random 15
.AP_Misc_Rapidash_Loop:
	ifgreater 16, .repeat
	writetext PokemonFanClubChairmanRapidashText3
	promptbutton
.HeardSpeechButBagFull:
	writetext PokemonFanClubChairmanIWantYouToHaveThisText
	promptbutton
.AP_NPC_PokemonFanClub_RARE_CANDY
	verbosegiveitem RARE_CANDY, EVENT_LISTENED_TO_FAN_CLUB_PRESIDENT
	iffalse .BagFull
...
.MetCopycat:
	...
	promptbutton
	waitsfx
.AP_NPC_PokemonFanClub_LOST_ITEM
	verbosegiveitem LOST_ITEM, EVENT_GOT_LOST_ITEM_FROM_FAN_CLUB
	iffalse .NoRoom
...
PokemonFanClubChairmanRapidashText2:
	text "So… my favorite"
	line "RAPIDASH…"
...
PokemonFanClubChairmanRapidashText3:
