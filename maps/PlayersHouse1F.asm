...
MeetMomRightScript:
.AP_Music_PlayersHouse1F1__MUSIC_MOM
	playmusic MUSIC_MOM
...
.AP_NPC_PlayersHouse1F_POKE_GEAR:
	verbosegiveitem POKE_GEAR, EVENT_GOT_POKEGEAR
	setevent EVENT_GOT_POKEGEAR
	setflag ENGINE_PHONE_CARD
; .AP_NPC_PlayersHouse1F_PHONE_CARD:
; 	verbosegiveitem PHONE_CARD
; 	setevent EVENT_GOT_PHONE_CARD
...
MeetMomTalkedScript:
.AP_Music_PlayersHouse1F2__MUSIC_MOM
	playmusic MUSIC_MOM
	sjump MeetMomScript
