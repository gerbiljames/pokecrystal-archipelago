...
.FightDone:
	opentext
	checkevent EVENT_HIVE_BADGE_FROM_BUGSY
	iftrue .GotBadge
.AP_Badge_AzaleaGym_HIVE_BADGE
	verbosegiveitem HIVE_BADGE, EVENT_HIVE_BADGE_FROM_BUGSY
	iffalse .NoRoom
	setevent EVENT_HIVE_BADGE_FROM_BUGSY
...
.AP_NPC_AzaleaGym_TM_FURY_CUTTER
	verbosegiveitem TM_FURY_CUTTER, EVENT_GOT_TM49_FURY_CUTTER
	iffalse .NoRoom
