...
Route25MistyDate1Script:
	...
	pause 15
.AP_Music_Route251__MUSIC_BEAUTY_ENCOUNTER
...
Route25MistyDate2Script:
	...
	disappear ROUTE25_COOLTRAINER_M1
	pause 15
.AP_Music_Route252__MUSIC_BEAUTY_ENCOUNTER
	playmusic MUSIC_BEAUTY_ENCOUNTER
	turnobject ROUTE25_MISTY, UP
	pause 10
...
TrainerCooltrainermKevin:
	...
	promptbutton
.AP_NPC_Route25_NUGGET
	verbosegiveitem NUGGET, EVENT_CLEARED_NUGGET_BRIDGE
