...
FuchsiaGymJanineScript:
	checkevent EVENT_SOUL_BADGE_FROM_JANINE
	iftrue .FightDone
	...
	opentext
.AP_Badge_FuschiaGym_SOUL_BADGE
	verbosegiveitem SOUL_BADGE, EVENT_SOUL_BADGE_FROM_JANINE
	setevent EVENT_SOUL_BADGE_FROM_JANINE
...
.AfterBattle:
	...
	promptbutton
.AP_NPC_FuchsiaGym_TM_TOXIC
	verbosegiveitem TM_TOXIC, EVENT_GOT_TM06_TOXIC
	iffalse .AfterTM
