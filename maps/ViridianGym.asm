...
ViridianGymBlueScript:
	faceplayer
	opentext
	checkevent EVENT_EARTH_BADGE_FROM_BLUE
	iftrue .FightDone
	...
	opentext
.AP_Badge_ViridianGym_EARTH_BADGE
	verbosegiveitem EARTH_BADGE, EVENT_EARTH_BADGE_FROM_BLUE
	setevent EVENT_EARTH_BADGE_FROM_BLUE
