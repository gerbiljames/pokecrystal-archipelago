...
.ShowedLickitung:
	...
	iftrue .GotEverstone
	scall .ReceiveItem
.AP_NPC_BillsHouse_EVERSTONE
	verbosegiveitem EVERSTONE, EVENT_GOT_EVERSTONE_FROM_BILLS_GRANDPA
	iffalse .BagFull
...
.ShowedOddish:
	...
	iftrue .GotLeafStone
	scall .ReceiveItem
.AP_NPC_BillsHouse_LEAF_STONE
	verbosegiveitem LEAF_STONE, EVENT_GOT_LEAF_STONE_FROM_BILLS_GRANDPA
	iffalse .BagFull
...
.ShowedStaryu:
	...
	scall .ReceiveItem
.AP_NPC_BillsHouse_WATER_STONE
	verbosegiveitem WATER_STONE, EVENT_GOT_WATER_STONE_FROM_BILLS_GRANDPA
	iffalse .BagFull
...
.ShowedPichu:
	scall .ReceiveItem
.AP_NPC_BillsHouse_THUNDERSTONE
	verbosegiveitem THUNDERSTONE, EVENT_GOT_THUNDERSTONE_FROM_BILLS_GRANDPA
	iffalse .BagFull
