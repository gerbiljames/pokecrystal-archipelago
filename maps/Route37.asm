...
.Kris:
	...
	promptbutton
.next
.AP_NPC_Route37_MAGNET
	verbosegiveitem MAGNET, EVENT_GOT_MAGNET_FROM_SUNNY
...
Route37_MapEvents:
	...
	object_event  7, 12, SPRITE_WEIRD_TREE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 1, TrainerTwinsAnnandanne1, -1
