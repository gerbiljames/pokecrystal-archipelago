...
GoldenrodUndergroundWarehouseDirectorScript:
	...
	promptbutton
.AP_NPC_GoldenrodUndergroundWarehouse_CARD_KEY
	verbosegiveitem CARD_KEY, EVENT_RECEIVED_CARD_KEY
...
GoldenrodUndergroundWarehouse_MapEvents:
	...
	def_object_events
	object_event  9,  8, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerGruntM24, EVENT_ROCKET_TAKEOVER_OR_AFTER
	object_event  8, 15, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerGruntM14, EVENT_ROCKET_TAKEOVER_OR_AFTER
	object_event 14,  3, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 4, TrainerGruntM15, EVENT_ROCKET_TAKEOVER_OR_AFTER
