...
.FightDone:
	opentext
	checkevent EVENT_RISING_BADGE_FROM_CLAIR
	iftrue .GotBadge
.AP_Badge_BlackthornGym_RISING_BADGE
	verbosegiveitem RISING_BADGE, EVENT_RISING_BADGE_FROM_CLAIR
	iffalse .BagFull
	setevent EVENT_RISING_BADGE_FROM_CLAIR
.GotBadge
	checkevent EVENT_GOT_TM24_DRAGONBREATH
	iftrue .GotTM
.AP_NPC_BlackthornGym_TM_DRAGONBREATH
	verbosegiveitem TM_DRAGONBREATH, EVENT_GOT_TM24_DRAGONBREATH
	iffalse .BagFull
