...
CeladonGymErikaScript:
	faceplayer
	opentext
	checkevent EVENT_RAINBOW_BADGE_FROM_ERIKA
	iftrue .FightDone
	...
	opentext
.AP_Badge_CeladonGym_RAINBOW_BADGE
	verbosegiveitem RAINBOW_BADGE, EVENT_RAINBOW_BADGE_FROM_ERIKA
	setevent EVENT_RAINBOW_BADGE_FROM_ERIKA
...
.FightDone:
	...
	promptbutton
.AP_NPC_CeladonGym_TM_GIGA_DRAIN
	verbosegiveitem TM_GIGA_DRAIN, EVENT_GOT_TM19_GIGA_DRAIN
