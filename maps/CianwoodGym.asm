...
.FightDone:
	opentext
	checkevent EVENT_STORM_BADGE_FROM_CHUCK
	iftrue .GotBadge
.AP_Badge_CianwoodGym_STORM_BADGE
	verbosegiveitem STORM_BADGE, EVENT_STORM_BADGE_FROM_CHUCK
	iffalse .BagFull
	setevent EVENT_STORM_BADGE_FROM_CHUCK
...
.GotBadge
	...
	iftrue .GotTM
.AP_NPC_CianwoodGym_TM_DYNAMICPUNCH
	verbosegiveitem TM_DYNAMICPUNCH, EVENT_GOT_TM01_DYNAMICPUNCH
	iffalse .BagFull
