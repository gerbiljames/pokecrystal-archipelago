...
.ClearedSudowoodo:
	...
	promptbutton
.AP_NPC_Route36_TM_ROCK_SMASH
	verbosegiveitem TM_ROCK_SMASH, EVENT_GOT_TM08_ROCK_SMASH
	iffalse .NoRoomForTM
...
.GiveFireStone:
	scall .Gift
.AP_NPC_Route36_FIRE_STONE
	verbosegiveitem FIRE_STONE, EVENT_ALAN_GAVE_FIRE_STONE
	iffalse .BagFull
...
.MetArthur:
	...
	promptbutton
.AP_NPC_Route36_HARD_STONE
	verbosegiveitem HARD_STONE, EVENT_GOT_HARD_STONE_FROM_ARTHUR
	iffalse .BagFull
