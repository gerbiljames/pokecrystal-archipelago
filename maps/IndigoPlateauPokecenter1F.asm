...
.AP_Music_IndigoPlateauPokecenter1F1__MUSIC_RIVAL_ENCOUNTER
...
.AP_Music_IndigoPlateauPokecenter1F2__MUSIC_RIVAL_ENCOUNTER
	playmusic MUSIC_RIVAL_ENCOUNTER
...
.AP_Music_IndigoPlateauPokecenter1F__MUSIC_RIVAL_AFTER
