...
.AP_Music_CeruleanGym__MUSIC_ROCKET_ENCOUNTER
...
CeruleanGymMistyScript:
	faceplayer
	opentext
	checkevent EVENT_CASCADE_BADGE_FROM_MISTY
	iftrue .FightDone
	...
	opentext
.AP_Badge_CeruleanGym_CASCADE_BADGE
	verbosegiveitem CASCADE_BADGE, EVENT_CASCADE_BADGE_FROM_MISTY
	setevent EVENT_CASCADE_BADGE_FROM_MISTY
	setmapscene ROUTE_25, SCENE_ROUTE25_NOOP
