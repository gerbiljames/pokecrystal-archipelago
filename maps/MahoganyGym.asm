...
.FightDone:
	opentext
	checkevent EVENT_GLACIER_BADGE_FROM_PRYCE
	iftrue .GotBadge
.AP_Badge_MahoganyGym_GLACIER_BADGE
	verbosegiveitem GLACIER_BADGE, EVENT_GLACIER_BADGE_FROM_PRYCE
	iffalse .NoRoom
	setevent EVENT_GLACIER_BADGE_FROM_PRYCE
...
.GotBadge
	...
	iftrue .GotTM
.AP_NPC_MahoganyGym_TM_ICY_WIND
	verbosegiveitem TM_ICY_WIND, EVENT_GOT_TM16_ICY_WIND
	iffalse .NoRoom
