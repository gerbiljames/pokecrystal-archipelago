...
SeafoamGymBlaineScript:
	faceplayer
	opentext
	checkevent EVENT_VOLCANO_BADGE_FROM_BLAINE
	iftrue .FightDone
...
.ReturnAfterBattle:
	...
	opentext
.AP_Badge_SeafoamGym_VOLCANO_BADGE
	verbosegiveitem VOLCANO_BADGE, EVENT_VOLCANO_BADGE_FROM_BLAINE
	setevent EVENT_VOLCANO_BADGE_FROM_BLAINE
