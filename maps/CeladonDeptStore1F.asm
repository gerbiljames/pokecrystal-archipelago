...
CeladonDeptStore1FClerkStonesScript:
	faceplayer
	opentext
...
CeladonDeptStore1F_MapEvents:
	...
	object_event 7,   1, SPRITE_GENTLEMAN, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeladonDeptStore1FGentlemanScript, -1
	...
	object_event 14,  7, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeladonDeptStore1FClerkStonesScript, -1
