...
.LeafStone:
	scall .Gift
.AP_NPC_Route34_LEAF_STONE
	verbosegiveitem LEAF_STONE, EVENT_GINA_GAVE_LEAF_STONE
	iffalse .BagFull
...
OfficerKeithScript:
	...
	iftrue .AfterScript
.AP_Music_Route34__MUSIC_OFFICER_ENCOUNTER
...
.Script:
	...
	promptbutton
.AP_NPC_Route34_SOFT_SAND
	verbosegiveitem SOFT_SAND, EVENT_GOT_SOFT_SAND_FROM_KATE
	iffalse .BagFull
