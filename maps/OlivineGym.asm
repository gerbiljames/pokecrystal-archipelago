...
.FightDone:
	opentext
	checkevent EVENT_MINERAL_BADGE_FROM_JASMINE
	iftrue .GotBadge
.AP_Badge_OlivineGym_MINERAL_BADGE
	verbosegiveitem MINERAL_BADGE, EVENT_MINERAL_BADGE_FROM_JASMINE
	iffalse .NoRoom
	setevent EVENT_MINERAL_BADGE_FROM_JASMINE
...
.GotBadge
	...
	iftrue .GotIronTail
.AP_NPC_OlivineGym_TM_IRON_TAIL
	verbosegiveitem TM_IRON_TAIL, EVENT_GOT_TM23_IRON_TAIL
	iffalse .NoRoom
