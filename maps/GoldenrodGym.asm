...
.StoppedCrying:
	checkevent EVENT_PLAIN_BADGE_FROM_WHITNEY
	iftrue .GotPlainBadge
	writetext WhitneyWhatDoYouWantText
	promptbutton
	waitsfx
.AP_Badge_GoldenrodGym_PLAIN_BADGE
	verbosegiveitem PLAIN_BADGE, EVENT_PLAIN_BADGE_FROM_WHITNEY
	iffalse .NoRoomForAttract
	setevent EVENT_PLAIN_BADGE_FROM_WHITNEY
...
.GotPlainBadge:
	...
	iftrue .GotAttract
.AP_NPC_GoldenrodGym_TM_ATTRACT
	verbosegiveitem TM_ATTRACT, EVENT_GOT_TM45_ATTRACT
	iffalse .NoRoomForAttract
