...
VermilionGymSurgeScript:
	faceplayer
	opentext
	checkevent EVENT_THUNDER_BADGE_FROM_LTSURGE
	iftrue .FightDone
	...
	opentext
.AP_Badge_VermillionGym_THUNDER_BADGE
	verbosegiveitem THUNDER_BADGE, EVENT_THUNDER_BADGE_FROM_LTSURGE
	setevent EVENT_THUNDER_BADGE_FROM_LTSURGE
