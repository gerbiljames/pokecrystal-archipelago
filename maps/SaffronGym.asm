...
SaffronGymSabrinaScript:
	faceplayer
	opentext
	checkevent EVENT_MARSH_BADGE_FROM_SABRINA
	iftrue .FightDone
	...
	opentext
.AP_Badge_SaffronGym_MARSH_BADGE
	verbosegiveitem MARSH_BADGE, EVENT_MARSH_BADGE_FROM_SABRINA
	setevent EVENT_MARSH_BADGE_FROM_SABRINA
