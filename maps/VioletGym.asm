...
.FightDone:
	opentext
	checkevent EVENT_ZEPHYR_BADGE_FROM_FALKNER
	iftrue .GotBadge
.AP_Badge_VioletGym_ZEPHYR_BADGE
	verbosegiveitem ZEPHYR_BADGE, EVENT_ZEPHYR_BADGE_FROM_FALKNER
	iffalse .NoRoom
	setevent EVENT_ZEPHYR_BADGE_FROM_FALKNER
...
.AP_NPC_VioletGym_TM_MUD_SLAP
	verbosegiveitem TM_MUD_SLAP, EVENT_GOT_TM31_MUD_SLAP
	iffalse .NoRoom
