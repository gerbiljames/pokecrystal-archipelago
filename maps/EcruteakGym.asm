...
.FightDone:
	opentext
	checkevent EVENT_FOG_BADGE_FROM_MORTY
	iftrue .GotBadge
.AP_Badge_EcruteakGym_FOG_BADGE
	verbosegiveitem FOG_BADGE, EVENT_FOG_BADGE_FROM_MORTY
	iffalse .NoRoom
	setevent EVENT_FOG_BADGE_FROM_MORTY
...
.AP_NPC_EcruteakGym_TM_SHADOW_BALL
	verbosegiveitem TM_SHADOW_BALL, EVENT_GOT_TM30_SHADOW_BALL
	iffalse .NoRoom
