...
.MetSantos:
	...
	promptbutton
.AP_NPC_BlackthornCity_SPELL_TAG
	verbosegiveitem SPELL_TAG, EVENT_GOT_SPELL_TAG_FROM_SANTOS
	iffalse .Done
...
BlackthornCity_MapEvents:
	...
	def_object_events
	object_event 18, 12, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BlackthornSuperNerdScript, EVENT_BLACKTHORN_CITY_SUPER_NERD_BLOCKS_GYM ;notracker
