...
.Continue:
.AP_Music_GoldenrodUndergroundSwitchRoomEntrances__MUSIC_RIVAL_ENCOUNTER
...
.FinishRivalBattle:
.AP_Music_GoldenrodUndergroundSwitchRoomEntrances__MUSIC_RIVAL_AFTER
...
GoldenrodUndergroundSwitchRoomEntrances_MapEvents:
	...
	def_object_events
	object_event  9, 12, SPRITE_PHARMACIST, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 2, TrainerBurglarDuncan, EVENT_ROCKET_TAKEOVER_OR_AFTER
	object_event  4,  8, SPRITE_PHARMACIST, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 2, TrainerBurglarEddie, EVENT_ROCKET_TAKEOVER_OR_AFTER
	object_event 17,  2, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerGruntM13, EVENT_ROCKET_TAKEOVER_OR_AFTER
	object_event 11,  2, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerGruntM11, EVENT_ROCKET_TAKEOVER_OR_AFTER
	object_event  3,  2, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerGruntM25, EVENT_ROCKET_TAKEOVER_OR_AFTER
	object_event 19, 12, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 1, TrainerGruntF3, EVENT_ROCKET_TAKEOVER_OR_AFTER
