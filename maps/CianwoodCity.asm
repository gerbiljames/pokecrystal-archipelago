...
.AP_Music_CianwoodCity1__MUSIC_MYSTICALMAN_ENCOUNTER
...
.AP_Music_CianwoodCity2__MUSIC_MYSTICALMAN_ENCOUNTER
	playmusic MUSIC_MYSTICALMAN_ENCOUNTER
	opentext
...
.BeatChuck:
	...
	promptbutton
.AP_NPC_CianwoodCity_HM_FLY
	verbosegiveitem HM_FLY, EVENT_GOT_HM02_FLY
	iffalse .Done
