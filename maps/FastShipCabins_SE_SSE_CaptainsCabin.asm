...
SSGiveItem:
	...
	promptbutton
.AP_NPC_FastShipCabins_SE_SSE_CaptainsCabin_METAL_COAT
	verbosegiveitem METAL_COAT, EVENT_GOT_METAL_COAT_FROM_GRANDPA_ON_SS_AQUA
	iffalse .NoRoom
...
FastShipCabins_SE_SSE_CaptainsCabin_MapEvents:
	...
	; object_event  3,  4, SPRITE_TWIN, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 1, TrainerTwinsMegandpeg1, EVENT_FAST_SHIP_PASSENGERS_FIRST_TRIP
