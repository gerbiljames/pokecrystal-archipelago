...
RadioTower5F_MapScripts:
	...
	scene_script RadioTower5FNoop3Scene, SCENE_RADIOTOWER5F_ONLY_DIRECTOR
...
.AP_Music_RadioTower5F1__MUSIC_BUENAS_PASSWORD
	...
	promptbutton
.AP_NPC_RadioTower5F_BASEMENT_KEY
	verbosegiveitem BASEMENT_KEY, EVENT_BEAT_ROCKET_EXECUTIVEM_3
	closetext
	setscene SCENE_RADIOTOWER5F_ROCKET_BOSS
	checkevent EVENT_TEAM_ROCKET_DISBANDED
	iffalse .NotBeatenExec
...
.AP_Music_RadioTower5F2__MUSIC_BUENAS_PASSWORD
	playmusic MUSIC_ROCKET_ENCOUNTER
	...
	promptbutton
.AP_NPC_RadioTower5F_CLEAR_BELL
	verbosegiveitem CLEAR_BELL, EVENT_GOT_CLEAR_BELL
	...
	iftrue .BeatDirector
	setscene SCENE_RADIOTOWER5F_ONLY_DIRECTOR
.BeatDirector:
...
RadioTower5F_MapEvents:
	...
	coord_event  0,  3, SCENE_RADIOTOWER5F_ONLY_DIRECTOR, FakeDirectorScript
	coord_event 16,  5, SCENE_RADIOTOWER5F_FAKE_DIRECTOR, RadioTower5FRocketBossScript
	...
	object_event 13,  5, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, -1
	object_event 17,  2, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 1, TrainerExecutivef1, -1
