...
.GiveMiracleSeed:
	...
	promptbutton
.AP_NPC_Route32_MIRACLE_SEED
	verbosegiveitem MIRACLE_SEED, EVENT_GOT_MIRACLE_SEED_IN_ROUTE_32
	iffalse .BagFull
...
Route32RoarTMGuyScript:
	...
	promptbutton
.AP_NPC_Route32_TM_ROAR
	verbosegiveitem TM_ROAR, EVENT_GOT_TM05_ROAR
	iffalse .Finish
...
.MetFrieda:
	...
	promptbutton
.AP_NPC_Route32_POISON_BARB
	verbosegiveitem POISON_BARB, EVENT_GOT_POISON_BARB_FROM_FRIEDA
	iffalse .Done
...
;did i remove the not friday script here??
.Friday:
...
Route32_MapEvents:
	...
	object_event 12, 67, SPRITE_LASS, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, FriedaScript, -1
