Intro_MainMenu:
	...
	call PlayMusic
	call DelayFrame
.AP_Music_intro_menu__MUSIC_MAIN_MENU
...
.AP_Music_intro_menu__MUSIC_ROUTE_30
...
.AP_Music_intro_menu__MUSIC_TITLE
	ld de, MUSIC_TITLE
	call PlayMusic
...
FillStartInventory:
	ld a, [AP_Setting_FreeFly]
	ld [wVisitedSpawns], a
	ld a, [AP_Setting_FreeFly + 1]
	ld [wVisitedSpawns + 1], a
	ld a, [AP_Setting_FreeFly + 2]
	ld [wVisitedSpawns + 2], a
	ld a, [AP_Setting_FreeFly + 3]
	ld [wVisitedSpawns + 3], a
    ld hl, StartInventoryTable + 255
    ld b, 129
; .noqty
; 	dec hl
.loop
