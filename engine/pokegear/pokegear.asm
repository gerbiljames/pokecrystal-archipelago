...
RadioMusicRestartPokemonChannel:
	...
	call PlayMusic
	pop de
.AP_Music_pokegear__MUSIC_POKEMON_CHANNEL
...
; visited and its flypoint enabled.
	...
	ld c, SPAWN_INDIGO
	call HasVisitedSpawn
	ld c, NUM_FLYPOINTS - 1
	and a
	jr nz, .YesKanto
	ld c, SPAWN_VERMILION
	call HasVisitedSpawn
	ld c, NUM_FLYPOINTS - 8
	and a
	jr nz, .YesKanto
	ld c, SPAWN_SAFFRON
	call HasVisitedSpawn
	ld c, NUM_FLYPOINTS - 4
	and a
	jr nz, .YesKanto
	jr .NoKanto
.YesKanto
; Kanto's map is only loaded if we've visited Indigo Plateau
	...
	ld [wStartFlypoint], a
	ld a, c
	ld [wTownMapPlayerIconLandmark], a ; default
...
MapCardFreeFly:
	...
	ret z
.AP_Setting_MapCardFreeFly_Byte
	ld a, 0
	and a
	ret z
	push hl
	push de
	ld hl, wVisitedSpawns
.AP_Setting_MapCardFreeFly_Offset
	ld de, 0
	add hl, de
	or [hl]
	ld [hl], a
