...
.itemball
	...
	add hl, bc
	ld a, [hli]
	ld [wItemBallEventFlag], a
	ld a, [hl]
	ld [wItemBallEventFlag + 1], a
	pop bc
	ld hl, MAPOBJECT_SCRIPT_POINTER
	add hl, bc
	ld a, [hli]
...
receiveArchipelagoItem:
	...
	call ReceiveItem
	jr nc, .bagFull
	ld a, [wArchipelagoItemIndex]
	ld c, a
	ld a, [wArchipelagoItemIndex2]
	ld b, a
	inc bc
	ld a, c
	ld [wArchipelagoItemIndex], a
	ld a, b
	ld [wArchipelagoItemIndex2], a
	ld a, [wArchipelagoItemReceived]
	ld c, a
	xor a
