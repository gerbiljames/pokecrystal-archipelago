...
Script_scripttalkafter:
	;push hl
	push de
	;ld a, [wTrainersanityItem]
	xor a
	ld [wTrainersanityShowMessage], a
	ld a, [wTrainersanityEventFlag]
	ld e, a
	ld a, [wTrainersanityEventFlag + 1]
	ld d, a
	ld b, CHECK_FLAG
	...
	ld b, SET_FLAG
	call EventFlagAction
.AP_Setting_TrainersanityMessages
	ld a, 1
	ld [wTrainersanityShowMessage], a
.dotalk
	pop de
...
Script_endifjustbattled:
	ld a, [wTrainersanityShowMessage]
	cp 1
	ld a, [wTrainersanityItem]
	jr c, .end
	jr nz, .sound
	...
	call ScriptLookupAPName
	;pop hl
	ld de, GiveItemScriptAPTrainer
	jp ReceiveAPItemJump
.normalitem
	call CurItemName
	ld de, wStringBuffer1
	ld a, STRING_BUFFER_4
	call CopyConvertedText
	;ld b, BANK(GiveItemScript2)
	ld de, GiveItemScript2
	;jp ScriptCall
	jp ReceiveAPItemJump
.sound
	ld c, a
...
ReceiveAPItem:
	ld de, GiveItemScriptAP
ReceiveAPItemJump:
	ld b, BANK(GiveItemScriptAP)
	jr ScriptCall
